...
makeTable([x_3,I_3,I_3-I_Dunkel*10**6], r'{'+r'$\Delta x/10^{-3}\si{\metre}$'+r'} & {'+r'$I_.{mess}/10^{-6}\si{\ampere}$'+r'} & {'+r'$I_.{eff}/10^{-6}\si{\ampere}$'+r'}','tabDoppel2',['S[table-format=2.2]','S[table-format=1.4]','S[table-format=1.4]'], ["%2.2f","%1.4f","%1.4f"])
